                        ...
                        <div className="grid md:grid-cols-2 gap-10 lg:gap-20 items-center">
                            <div className="space-y-6">
                                ...
                                <p className="text-[16px] text-[#A1A1AA] font-light leading-relaxed">
                                    We believe that productivity tooling shouldn&rsquo;t feel like a chore. The tools we use every day form the environment where we think, work, and create.
                                </p>
                                <p className="text-[16px] text-[#A1A1AA] font-light leading-relaxed">
                                    Our mission is to bring a zero-compromise, premium software experience to the Linux ecosystem. We obsess over milliseconds of latency, precise vector rendering, and incredibly intuitive interfaces so you can focus entirely on what you&rsquo;re capturing.
                                </p>
                            </div>
